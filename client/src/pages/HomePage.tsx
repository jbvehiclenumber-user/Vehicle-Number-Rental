...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-hidden ${visibleSections.has('footer') ? 'section-visible' : ''}`}>
          <div className="text-center mb-6">
            ...
            <div className="space-y-3">
              <p className="text-gray-300 flex items-center justify-center gap-2">
                ...
                <a href="tel:042-624-7000" className="hover:text-white transition">
                  042-624-7000
                </a>
              </p>
              <p className="text-gray-300 flex items-center justify-center gap-2">
                ...
                <a href="mailto:jhshin@jungbulogis.co.kr" className="hover:text-white transition">
                  jhshin@jungbulogis.co.kr
                </a>
              </p>
            </div>
          </div>
          <div className="text-center pt-6 border-t border-gray-700">
            <p className="text-gray-400">&copy; 2025 에스에이치물류. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
